    ...
    const renderLabel = (type) => (
        <Box 
            ...
            sx={{
                ...
                fontSize: '10px',
                fontWeight: 500,
                color: type === 'free' ? '#333' : '#004085',
                backgroundColor: type === 'free' ? '#e0e0e0' : '#cce5ff',
        ...
        >
            ...
            <List sx={{ pt: 0 }}>
                <ListItemButton
                    ...
                    sx={getHoverStyles(activeItem === 'TeamMenu')}
                >
                    <ListItemIcon>
                        ...
                        {teamItems.map((team) => {
                            ...
                            return (
                                <ListItemButton
                                    ...
                                    sx={{
                                        pl: 4,
                                        ...getHoverStyles(activeItem === team.id)
                                    }}
                ...
                {/* <Divider sx={{ my: 2 }} variant="middle" />a */}
